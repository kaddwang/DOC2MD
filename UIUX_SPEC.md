...
| 類型 | 代碼 | 背景色 | 邊框色 | 尺寸(px) | 字體(px) | 說明 |
|------|------|--------|--------|----------|----------|------|
| Company | `company` | `#FFD700` 金色 | `#B8860B` | 85 | 14 | 最高層級，最大最醒目 |
| Product | `product` | `#6c63ff` 紫色 | `#4a42d4` | 65 | 12 | 第二層級，品牌色 |
| MAAC Module | `maac_module` | `#4fc3f7` 淺藍 | `#039be5` | 28 | 9 | 產品模組層 |
| CAAC Module | `caac_module` | `#66bb6a` 綠色 | `#43a047` | 28 | 9 | 產品模組層 |
| DAAC Module | `daac_module` | `#ffa726` 橙色 | `#ef6c00` | 28 | 9 | 產品模組層 |
| CDH Module | `cdh_module` | `#ef5350` 紅色 | `#c62828` | 28 | 9 | 產品模組層 |
| Infrastructure | `infra` | `#90a4ae` 灰藍 | `#546e7a` | 22 | 8 | 基礎設施，最小 |
| Shared Service | `shared_service` | `#b39ddb` 淺紫 | `#7e57c2` | 24 | 9 | 共用服務 |
| MAAC Frontend | `maac_frontend` | `#80cbc4` 青綠 | `#00897b` | 16 | 7 | 前端頁面，最外圈 |
| CAAC Frontend | `caac_frontend` | `#a5d6a7` 淺綠 | `#388e3c` | 16 | 7 | 前端頁面，最外圈 |

> **設計要點**: 每種產品的模組使用該產品的主色調衍生色，讓使用者一眼即可辨識所屬產品。
